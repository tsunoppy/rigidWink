...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.6 on Sat Nov 28 12:42:27 2020
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.Ctrl = wx.Menu()
        item = self.Ctrl.Append(wx.ID_ANY, "&Export as xlsx", "")
        self.Bind(wx.EVT_MENU, self.OnLoad, id=item.GetId())
        item = self.Ctrl.Append(wx.ID_ANY, "&Import as xlsx", "")
        ...
        item = wxglade_tmp_menu.Append(wx.ID_ANY, "&About rigidWink", "")
        self.Bind(wx.EVT_MENU, self.OnAbout, id=item.GetId())
        item = wxglade_tmp_menu.Append(wx.ID_ANY, "&Reference", "")
        self.Bind(wx.EVT_MENU, self.OnRef, id=item.GetId())
    ...
    def __set_properties(self):
        ...
        _icon = wx.NullIcon
        _icon.CopyFromBitmap(wx.Bitmap("./images/plate.ico", wx.BITMAP_TYPE_ANY))
        self.SetIcon(_icon)
        ...
        self.grid_ctln.CreateGrid(10, 3)
        self.grid_ctln.SetColLabelValue(0, "title")
        self.grid_ctln.SetColSize(0, 150)
        self.grid_ctln.SetColLabelValue(1, "r, model")
        self.grid_ctln.SetColLabelValue(2, "r, uplift")
