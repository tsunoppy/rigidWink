...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.6 on Sat Nov  7 14:49:38 2020
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.SetSize((935, 827))
        
        # Menu Bar
        self.frame_menubar = wx.MenuBar()
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(wx.ID_ANY, "&New", "")
        wxglade_tmp_menu.Append(wx.ID_ANY, "&Save as xls", "")
        wxglade_tmp_menu.Append(wx.ID_ANY, "&Export as pdf", "")
        wxglade_tmp_menu.Append(wx.ID_ANY, "&Export as txt", "")
        wxglade_tmp_menu.AppendSeparator()
        wxglade_tmp_menu.Append(wx.ID_ANY, "E&xit", "")
        self.frame_menubar.Append(wxglade_tmp_menu, "&File")
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(wx.ID_ANY, "&Copy", "")
        wxglade_tmp_menu.Append(wx.ID_ANY, "&Cut", "")
        wxglade_tmp_menu.Append(wx.ID_ANY, "&Paste", "")
        ...
        self.list_ctrl_1 = wx.ListCtrl(self.notebook_1_CTLN, wx.ID_ANY, style=wx.LC_HRULES | wx.LC_REPORT | wx.LC_VRULES)
        ...
        self.text_ctrl_result = wx.TextCtrl(self.panel_result, wx.ID_ANY, "Welcom to rigidWink!")
        ...
        self.matplotlib_canvas = FigureCanvas(self.notebook_2_pane_2, wx.ID_ANY, figure)
        ...
        self.text_ctrl_detail = wx.TextCtrl(self.notebook_2_Detail, wx.ID_ANY, "", style=wx.TE_MULTILINE)
        self.button_5 = wx.Button(self, wx.ID_ANY, "View Model")
        self.button_8 = wx.Button(self, wx.ID_ANY, "PREVIOUSE")
    ...
    def __set_properties(self):
        ...
        self.list_ctrl_1.AppendColumn("GMIN", format=wx.LIST_FORMAT_LEFT, width=-1)
        self.list_ctrl_1.AppendColumn("GMAX", format=wx.LIST_FORMAT_LEFT, width=-1)
        self.list_ctrl_1.AppendColumn("s", format=wx.LIST_FORMAT_LEFT, width=-1)
        self.grid_model.CreateGrid(10, 7)
        self.grid_model.SetSelectionMode(wx.grid.Grid.SelectRows)
        self.grid_model.SetColLabelValue(0, "X1")
        self.grid_model.SetColLabelValue(1, "X2")
        self.grid_model.SetColLabelValue(2, "Y1")
        self.grid_model.SetColLabelValue(3, "Y2")
        self.grid_model.SetColLabelValue(4, "Dimx")
        self.grid_model.SetColLabelValue(5, "Dimy")
        self.grid_model.SetColLabelValue(6, "kb")
        ...
        self.grid_comb.CreateGrid(10, 11)
        self.grid_comb.SetColLabelValue(0, "Case")
        self.grid_comb.SetColLabelValue(1, "Vmin")
        self.grid_comb.SetColLabelValue(2, "Vmax")
        self.grid_comb.SetColLabelValue(3, "x")
        self.grid_comb.SetColLabelValue(4, "Load1")
        self.grid_comb.SetColLabelValue(5, "x")
        self.grid_comb.SetColLabelValue(6, "Load2")
        self.grid_comb.SetColLabelValue(7, "x")
        self.grid_comb.SetColLabelValue(8, "Load3")
        self.grid_comb.SetColLabelValue(9, "x")
        self.grid_comb.SetColLabelValue(10, "Load4")
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        sizer_6 = wx.StaticBoxSizer(wx.StaticBox(self.panel_result, wx.ID_ANY, "Summary"), wx.HORIZONTAL)
        sizer_8 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_7 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_3 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_11 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_11.Add(self.list_ctrl_1, 1, wx.EXPAND, 0)
        self.notebook_1_CTLN.SetSizer(sizer_11)
        ...
        sizer_9.Add(self.matplotlib_canvas, 1, wx.EXPAND, 0)
        ...
        self.notebook_2.AddPage(self.notebook_2_STRESS, "STRESS")
        ...
        sizer_5.Add(self.button_8, 0, wx.ALIGN_CENTER_VERTICAL, 0)
